package com.yaegar.yaegarbooksrestservice.aspect;

import com.yaegar.yaegarbooksrestservice.config.jwt.dto.JwtUserDto;
import com.yaegar.yaegarbooksrestservice.config.jwt.model.JwtAuthenticationToken;
import com.yaegar.yaegarbooksrestservice.config.jwt.util.JwtTokenValidator;
...
public class RestControllerAdvice {
    ...
    @Pointcut("execution(* com.yaegar.yaegarbooksrestservice.controller.*.*(..))")
                ...
                if (header.startsWith("Bearer ")) {
                    ...
                    if (parsedUser != null) {
                        ...
                        if (userOptional.isPresent()) {
                            ...
                            logger1.append(" ");
                            //                        logger1.append(userOptional.get().getLastName());
                            logger1.append(" ");
